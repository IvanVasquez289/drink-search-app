...
export default function GenerateAI() {
  ...
  const recipe = useAppStore(state => state.recipeAI)
        ...
        >
          <div className="relative">
            ...
            <button 
              type="submit" 
              aria-label="Enviar"
              className={`cursor-pointer absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2 disabled:opacity-50 disabled:cursor-not-allowed`}
